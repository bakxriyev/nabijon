...
export default function PremiumMedicalCard() {
  ...
  const [profile] = useState({
    ...
    logo: './klinika.jpg',
    socialLinks: [
      { id: 1, platform: 'Инстаграм', url: 'https://www.instagram.com/soglom_hayot_klinikasi?igsh=bnhrY2o3M3VmMmc=', icon: 'instagram' },
      { id: 2, platform: 'Телеграм', url: 'https://t.me/SoglomHayot2022klinika', icon: 'telegram' },
      { id: 3, platform: 'Локатция', url: 'https://yandex.ru/maps/-/CLGLrXiP', icon: 'Location' }
    ]
  })
        ...
        <div className="card-3d bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 py-5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white flex items-center justify-between gap-4">
            ...
            <div className="w-14 h-14 rounded-full bg-white p-1 flex items-center justify-center shadow">
              <img src={profile.logo} alt="logo" className="object-contain w-full h-full rounded-full" />
            </div>
          </div>
...
Набижон Пиримович мамлакатимизда биринчи бўлиб Польша Республикасида орттирилган тажриба асосида юрак ишемик касаллигини даволашда биосўрилувчан каркасларни қўллашни амалиётини тадбиқ этди.`
  ...
  2018 йилдан хозирга кадар  Юлдошев Набижон Пиримович раҳбарлигида 4 та тиббиёт йўналишидаги фалсафа доктори диссертацияси мувафаққиятли ҳимоя қилинди. Ҳозирги кунда 1 та фалсафа докторига талабгорлик диссертациялари бўйича илмий ишлар олиб борилмоқда.   
